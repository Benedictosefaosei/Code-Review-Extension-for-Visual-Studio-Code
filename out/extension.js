...
function getPersonalQuizFolderPath() {
    const basePath = path.join(os.homedir(), 'Downloads', 'pl-gvsu-cis500dev', 'questions', 'PersonalQuiz');
...
`;
    ...
    let generatePersonalizedQuizCommand = vscode.commands.registerCommand('extension.generatePersonalizedQuiz', () => __awaiter(this, void 0, void 0, function* () {
        ...
        vscode.window.showInformationMessage(`Personalized quiz generated successfully in: ${userFolderPath}`);
    }));
